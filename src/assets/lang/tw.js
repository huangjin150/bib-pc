module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: "多終端APP",
        brandTitle: "關於BITYOND",
        brandDetail: "誠實 | 公平 | 熱情 | 開放",
        brandDesc1: "BITYOND.PRO由一群比特幣早期參與者與極客創立，團隊核心成員來自於谷歌、微軟、阿里巴巴、騰訊等知名企業，具有深厚的研發實力與豐富的互聯網產品運營經驗。",
        brandDesc2: "BITYOND.PRO定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著“不作惡”的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有利於用戶根本利益的伙伴/項目。",
        gettingstart: "新手入門 | 極速買幣",
        officialstart: "BITYOND官方新手入門輔助通道",
        oneminutebuy: "法幣通道",
        oneminutebuytips: "用人民幣買賣比特幣等",
        baseknow: "區塊鏈基礎",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活動最終解釋權歸幣嚴(WWW.BITYOND.PRO)官方所有",
        inputamount: "輸入兌換數量",
        ...
        submit: "提交",
        tipsmobile: "請進入電腦端頁面參與（www.BITYOND.pro）",
        tipsmobile1: "請在電腦端打開（www.BITYOND.pro）並進入創新實驗區參與",
        intvalue: "請輸入整數",
    ...
    invite: {
        ...
        partnerlevel: "合夥級別",
        ruledetail: "規則詳情",
        ruleprofile1: "幣嚴(WWW.BITYOND.PRO)的【推廣合夥人】是全網",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣時長最長(最高終身返佣)",
        ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴(WWW.BITYOND.PRO)交易平台共同成長的紅利！具體細則如下：",
        ruletext1: "一、為佈道數字資產理念與擴大用戶規模，幣嚴(WWW.BITYOND.PRO)推出【推廣合夥人】計劃，該活動長期有效。",
        ...
        thanks: "感謝您陪著幣嚴(WWW.BITYOND.PRO)一起成長！",
        headertip: "以上佣金數據非實時更新，系統每24H統計並更新一次。",
        ptools: "推廣工具箱",
        pt_title: "數字貨幣禮品卡",
        pt_desc: "兌換後自動成為下級好友，送朋友、送親人、送客戶、送夥伴。助力推廣合夥人更好推廣。",
        pt_more: "更多工具，敬請期待",
        pt_tips: "如果您有好的創意，請發送郵件至promotion@BITYOND.pro，採納後有獎勵哦！",
        pt_card_amount: "卡面金額",
        ...
        pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴(WWW.BITYOND.PRO)官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
        ...
        pt_card_rule6: "六、免費禮品卡最終解釋權歸BITYOND.PRO所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        finance: {
            ...
            record: {
                ...
                transMessage13: '配對',
                transMessage14: "活動兌換",
                transMessage15: "CTC買入",
                transMessage16: "CTC賣出",
                transMessage17: "發紅包",
                transMessage18: "領紅包",
                transMessage19: "提幣碼提幣",
                transMessage20: "提幣碼充幣",
                transMessage21: "永續合約手續費",
                transMessage22: "永續合約盈利",
                transMessage23: "永續合約虧損",
                transMessage24: "永續合約資金費",
                transMessage25: "預測合約失敗",
                transMessage26: "預測合約手續費",
                transMessage27: "預測合約獎金",
                transMessage28: "人工扣款",
                transMessage29: "資金劃轉-轉入",
                transMessage30: "資金劃轉-轉出",
                transMessage31: "預測下單",
                transMessage32: "預測盈利",
    ...
    description: {
        ...
        message5: "幣嚴(WWW.BITYOND.PRO)國際數字加密資產交易平台手機客戶端，專注掌上交易體驗",
        scanqrcode: "掃描二維碼，下載APP",
        aboutdesc1: "幣嚴(WWW.BITYOND.PRO)是技術全球領先的數字資產交易平台，註冊於開曼群島，核心運營團隊位於香港。幣嚴(WWW.BITYOND.PRO)核心成員來自於頂級互聯網和金融公司，大部分成員是深度比特幣和區塊鏈信仰者，我們深信區塊鏈將改變傳統壟斷性金融體系，會建立一個更加民主、自治的社會結構。",
        aboutdesc2: "幣嚴(WWW.BITYOND.PRO)平台擁有專業金融級別的交易架構，擁有自主研發的高並發內存撮合交易引擎，平台採用全冷充值錢包系統+多重簽名+高防護DDOS攻擊系統等交易架構，保證客戶資產安全。",
        aboutdesc3: "幣嚴(WWW.BITYOND.PRO)為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在25分鐘內完成資產充提。",
        aboutdesc4: "幣嚴(WWW.BITYOND.PRO)嚴格篩選優質項目並提供安全穩定的資產託管服務。幣嚴(WWW.BITYOND.PRO)秉承著“誠實、公正、熱情、開放”的理念，竭力為用戶打造安全、可靠、高效和友好的極致交易所。",
        ...
        community: "幣嚴社區",
        wechat: "微信",
        addwechat: "添加 “BITYOND01” 為微信好友，進入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "幣用",
        telegram: "電報",
    ...
    bzb_description: {
        ...
        desc4: "參與BITYOND社區投票活動，包括但不限於上幣、回購等",
    ...
    index: {
        ...
        BHBregister: "BITYOND賬戶註冊",
        tibi: "提幣到賬時間及限額",
        line_plane: "BHB上線計劃、流通量及手續費返還公告",
        fenpeijizhi: "關於BITYOND收入分配機制的說明",
        jiangli_jihua: "邀請挖礦獎勵計劃",
        friend_fanhuan: "邀請好友、賺取額外手續費返還"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者權益)",
        content1: "正如白皮書所描述的，BITYOND會拿出平台的80% (扣除稅費後) 的收入分配給BITYOND持有者，20%的收入用來支持平台的研發及運營。",
    ...
    Invitecommissionrebate: {
        Invitefriends: '邀請好友',
        Invitefriends1: '好友將獲得 100 USDT 的手續費返還券。',
        Invitefriends2: '只需幾個步驟，即可獲得返傭獎勵。',
        Invitefriends3: '如何邀請好友',
        Invitefriends4: '將您的邀請連結分享給好友',
        Invitefriends5: '邀請好友註冊',
        Invitefriends6: '好友將收到 100 USDT 的手續費返還券',
        Invitefriends7: '立即賺取收益',
        Invitefriends8: '邀請好友，立得 10%~50% 手續費獎勵',
        Invitefriends9: '邀請好友，好友將獲得價值 100 美元的交易手續費返還券。',
        Invitefriends10: '邀請方式',
        Invitefriends11: '邀請碼',
        Invitefriends12: '邀請連結',
        Invitefriends13: '1. 將您的邀請連結分享給好友',
        Invitefriends14: '2. 邀請好友註冊 Bityond 帳戶，好友可獲得 100 USDT 的手續費返還券',
        Invitefriends15: '3. 好友參與合約交易後，邀請人可立即獲得 10%~50% 的手續費返還',
    },
    PlatformIntroduction: {
        introduce1: '港股上市 推動創新',
        introduce2: '共建未來',
        introduce3: '融資動態',
        introduce4: 'Bityond 成功完成 1000 萬美元的 A 輪融資，本輪融資由 Sunfund Fortuna Global Opportunities 領投，鼎億集團投資、SDM 教育、TigerVCDAO 等多家知名港股上市公司跟投。此次融資使 Bityond 的估值達到 1 億美元，為公司在區塊鏈、現實世界資產（RWA）、數位身份和數位資產等領域的進一步發展提供了強大支持。',
        introduce5: 'Bityond 投資機構',
        introduce6: '東皓亞洲旗下基金：於 2017 年在開曼群島成立，為 Sunfund Asia 旗下全球投資基金，資產管理規模超過 10 億美元。Sunfund Fortuna 自成立以來，先後投資了 SpaceX、Airbnb、Zoom、NIO（蔚來汽車）、快手、滴滴出行等項目，在資本市場取得了輝煌的成績，為投資者帶來了豐厚回報。',
        introduce7: '由分散於美國、英國、新加坡、土耳其、中國香港、中國大陸等地的數十位資深 Web3 從業者與投資人自發組建，這些 Builder 的平均加密行業資歷約 4 年以上，其中不乏 Nasdaq 加密上市公司董事長、數億美元基金管理人、全球頂級智能合約審計機構以及十多家 Crypto VC 等，既擁有豐富的 Web3 從業經驗，也活躍於 Web3 投資一線。',
        introduce8: '戰略合作',
        introduce9: '隨著本輪融資的完成，Bityond 與多家投資方在多個關鍵領域達成戰略合作夥伴關係。這些合作將為我們在以下領域的持續創新與發展提供有力支持：',
        introduce10: '區塊鏈技術',
        introduce11: '推動區塊鏈技術的應用與拓展，提升數位金融服務的安全性與效率。',
        introduce12: '現實世界資產（RWA）',
        introduce13: '加速傳統資產的數位化轉型，實現現實世界資產的鏈上管理。',
        introduce14: '數位身份',
        introduce15: '探索數位身份在教育與金融中的應用，為用戶提供更安全便捷的服務。',
        introduce16: '數位資產',
        introduce17: '推動數位資產的普及與應用，加速 Web3 生態系統的建設。',
        introduce18: '關於 Bityond',
        introduce19: 'Bityond 是一家領先的數位資產交易平台，致力於通過創新的區塊鏈技術與加密貨幣解決方案，推動傳統金融市場與 Web3 生態的深度融合。公司提供全面的數位金融服務，包括資產管理、交易、質押與支付，為全球用戶提供優質的投資機會與融資服務。',
        introduce20: '準備好了嗎？馬上開始數位貨幣交易',
        introduce21: '為全球用戶提供全方位數位資產交易服務',
        introduce22: '加入我們',
        introduce23: '',
    }
