module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于Abtcoin",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "https://www.Abtcoin.io由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "https://www.Abtcoin.io定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "Abtcoin官方新手入门辅助通道",
        oneminutebuy: "法币通道",
    ...
    ctc: {
        ...
        desc: "由Abtcoin平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归Abtcoin(Abtcoin)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（https://www.Abtcoin.io）",
        tipsmobile1: "请在电脑端打开（https://www.Abtcoin.io）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1: "Abtcoin(Abtcoin)的【推广合伙人】是全网",
        ruleprofile2: "返佣比例最高、",
        ruleprofile3: "返佣时长最长(最高终身返佣)",
        ruleprofile4: "的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与Abtcoin(Abtcoin)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，Abtcoin(Abtcoin)推出【推广合伙人】计划，该活动长期有效。",
        ...
        thanks: "感谢您陪着Abtcoin(Abtcoin)一起成长！",
        headertip: "以上佣金数据非实时更新，系统每24H统计并更新一次。",
        ptools: "推广工具箱",
        pt_title: "数字货币礼品卡",
        pt_desc: "兑换后自动成为下级好友，送朋友、送亲人、送客户、送伙伴。助力推广合伙人更好推广。",
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@Abtcoin.io，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由Abtcoin(Abtcoin)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归https://www.Abtcoin.io所有。",
        pt_card_day: "天",
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "AbtcoinAPP - 全球数字资产交易平台"
    },
    description: {
        // message1: 'SSL、动态身份验证等银行级别安全技术，\n保障交易安全；支持多种数字货币交易',
        // message2: '严格的项目准入门槛，确保平台用户利益；\n100%保证金，钱包冷热隔离，确保用户资金安全',
        // message3: 'Abtcoin数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '金融级安全',
        title2: '极速充提',
        title3: '全球服务',
        title4: '严选资产',
        ...
        message5: 'Abtcoin(Abtcoin)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "Abtcoin(Abtcoin)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。Abtcoin(Abtcoin)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "Abtcoin(Abtcoin)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "Abtcoin(Abtcoin)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "Abtcoin(Abtcoin)严格筛选优质项目并提供安全稳定的资产托管服务。Abtcoin(Abtcoin)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        community: "Abtcoin社区",
        wechat: "微信",
        addwechat: "添加 “Abtcoin01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与Abtcoin社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "Abtcoin账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于Abtcoin收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，Abtcoin会拿出平台的80% (扣除税费后) 的收入分配给Abtcoin持有者，20%的收入用来支持平台的研发及运营。",
    ...
    Invitecommissionrebate: {
        ...
        Invitefriends14: '2. 邀请好友注册Abtcoin账户,好友获得100USDT的手续费返还券',
    ...
    PlatformIntroduction: {
        ...
        introduce2: '共建未来',
        introduce3: '融资动态',
        introduce4: 'Abtcoin成功完成1000万美元的A轮融资，本轮融资由Sunfund Fortuna GlobalOpportunities领投，鼎亿集团投资、SDM教育、TigerVCDAO等多家知名港股上市公司跟投。此次融资使Abtcoin的估值达到1亿美元，为公司在区块链、现实世界资产（RWA）、数字身份和数字资产等领域的进一步发展提供了强大支持。',
        introduce5: 'Abtcoin 投资机构',
        ...
        introduce8: '战略合作',
        introduce9: '随着本轮融资的完成，Abtcoin与各大投资方在多个关键领域达成了战略合作伙伴关系。这些合作将为我们在以下领域的持续创新与发展提供有力支持',
        introduce10: '区块链技术',
        ...
        introduce18: '关于Abtcoin',
        introduce19: 'Abtcoin是一家领先的数字资产交易平台，致力于通过创新的区块链技术和加密货币解决方案，推动传统金融市场与Web3生态系统的深度融合。公司提供全面的数字金融服务，包括资产管理、交易、质押和支付，为全球用户提供优质的投资机会和融资服务。',
