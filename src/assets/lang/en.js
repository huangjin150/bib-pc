module.exports = {
    ...
    header: {
        ...
        rakeback: 'Invite commission rebate',
        ...
        lab: "BITYOND Lab",
        ctc: "C2C Exchange",
        labdetail: "BITYOND Lightning Lab",
    ...
    sectionPage: {
        ...
        brandTitle: "About BITYOND",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "BITYOND was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "BITYOND is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "BITYOND Official Customer Service",
        ...
        baseexchangetips: "How to buy and sell on BITYOND",
    ...
    swap: {
        ...
        pos_qiangping: 'Strong flat price',
    ...
    ctc: {
        ...
        desc: "Crypto assets are managed by BITYOND, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of BITYOND.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.Bityond.io）",
    ...
    invite: {
        ...
        ruleprofile1: "[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with BITYOND trading platform. Detailed rules are as follows:",
        ruleprofile2: "",
        ruleprofile3: "",
        ruleprofile4: "",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, BITYOND launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to BITYOND.",
        ...
        thanks: "Thank you for supporting BITYOND！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@Bityond.io, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to Bityond.io.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            record: {
                ...
                activityaward: 'Activity Award',
                promotionaward: 'Promotion Award',
                transMessage12: 'Manual recharge',
                dividend: 'Dividend',
                vote: 'Vote',
                handrecharge: 'Artificial recharge',
                match: 'Match',
                chargetime: 'Charge Time',
                type: 'Type',
                transMessage30: "Funds Transfer - Transfer Out",
                num: 'Amount',
                status: 'Status',
                finish: 'Finished',
                fee: 'Fee',
                ...
                other: "Other",
                transMessage2: 'Wallet recharge',
                transMessage3: 'Wallet withdrawal',
                transMessage4: 'transfer accounts',
                transMessage5: 'Currency trading',
                transMessage6: 'Buy fiat currency',
                transMessage7: 'Selling fiat currency',
                transMessage8: 'Activity rewards',
                transMessage9: 'Promotion rewards',
                transMessage10: 'dividend',
                transMessage11: 'vote',
                transMessage12: 'Manual recharge',
                transMessage13: 'pair',
                transMessage14: "Event redemption",
                transMessage15: "CTC purchase",
                transMessage16: "Sell CTC",
                transMessage17: "Hand out red envelopes",
                transMessage18: "Receive a red envelope",
                transMessage19: "Withdrawal code withdrawal",
                transMessage20: "Withdrawal code and deposit",
                transMessage21: "Perpetual contract handling fee",
                transMessage22: "Profit from perpetual contracts",
                transMessage23: "Perpetual contract losses",
                transMessage24: "Perpetual contract funding fee",
                transMessage25: "Prediction contract failure",
                transMessage26: "Predict contract handling fees",
                transMessage27: "Predicting contract bonuses",
                transMessage28: "Manual deduction",
                transMessage29: "Funds Transfer - In",
                transMessage30: "Funds Transfer - Transfer Out",
                transMessage31: "Predict order placement",
                transMessage32: "Predicting profits",
                transMessage33: "手续费返还",
                transMessage34: "手续费奖励领取",
            },
            recharge: {
                recharge: 'Deposit',
                symbol: 'Coin',
        ...
        identity: {
            ...
            become: "Become BITYOND Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "BITYOND APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "Bityond.io is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of Bityond.io come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "Bityond.io platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, Bityond.io adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "Bityond.io strictly screens high-quality projects and provides secure and stable asset hosting services. Bityond.io upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "BITYOND Community",
        wechat: "Wechat",
        addwechat: "Add 'BITYOND01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "BITYOND account registration",
        ...
        fenpeijizhi: 'A description of the BITYOND income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, BITYOND will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
    ...
    Invitecommissionrebate: {
        Invitefriends: 'Invite Friends',
        Invitefriends1: 'Friends will receive a $100 USDT trading fee rebate voucher.',
        Invitefriends2: 'Just a few steps to earn commission rewards.',
        Invitefriends3: 'How to Invite Friends',
        Invitefriends4: 'Share your invitation link with friends',
        Invitefriends5: 'Invite friends to register',
        Invitefriends6: 'Friends will receive a $100 USDT trading fee rebate voucher',
        Invitefriends7: 'Start earning now',
        Invitefriends8: 'Invite friends and earn 10%~50% trading fee rewards instantly',
        Invitefriends9: 'Invite friends and they will receive a $100 trading fee rebate voucher.',
        Invitefriends10: 'Invitation Methods',
        Invitefriends11: 'Invitation Code',
        Invitefriends12: 'Invitation Link',
        Invitefriends13: '1. Share your invitation link with friends',
        Invitefriends14: '2. Invite friends to register a Bityond account and get a $100 USDT trading fee rebate voucher',
        Invitefriends15: '3. Once friends trade contracts, you will instantly receive 10%~50% of their trading fees as a rebate',
    },
    PlatformIntroduction: {
        introduce1: 'Hong Kong Listed Company Driving Innovation',
        introduce2: 'Building the Future Together',
        introduce3: 'Funding News',
        introduce4: 'Bityond has successfully completed a $10 million Series A funding round, led by Sunfund Fortuna Global Opportunities, with follow-on investments from Ding Yi Group Investment, SDM Education, TigerVCDAO, and other well-known Hong Kong-listed companies. This round brings Bityond’s valuation to $100 million, providing strong support for its further development in blockchain, real-world assets (RWA), digital identity, and digital assets.',
        introduce5: 'Bityond’s Investors',
        introduce6: 'Donghao Asia Fund: Established in 2017 in the Cayman Islands, it is a global investment fund under Sunfund Asia with assets under management exceeding $1 billion. Since its inception, Sunfund Fortuna has invested in projects such as SpaceX, Airbnb, Zoom, NIO, Kuaishou, and Didi, achieving outstanding performance and returns for investors.',
        introduce7: 'Formed by dozens of experienced Web3 practitioners and investors across the U.S., U.K., Singapore, Turkey, Hong Kong, and mainland China. These builders have an average of over 4 years in the crypto industry, including chairpersons of Nasdaq-listed crypto companies, managers of multi-hundred-million-dollar funds, top smart contract auditing firms, and numerous Crypto VCs. They are highly experienced and active on the frontlines of Web3 investment.',
        introduce8: 'Strategic Cooperation',
        introduce9: 'With the completion of this funding round, Bityond has formed strategic partnerships with major investors across several key sectors. These collaborations will provide strong support for continuous innovation and development in the following areas:',
        introduce10: 'Blockchain Technology',
        introduce11: 'Promoting the application and expansion of blockchain technology to enhance the security and efficiency of digital financial services.',
        introduce12: 'Real-World Assets (RWA)',
        introduce13: 'Accelerating the digital transformation of traditional assets to achieve on-chain management of real-world assets.',
        introduce14: 'Digital Identity',
        introduce15: 'Exploring the application of digital identity in education and finance to provide users with more secure and convenient services.',
        introduce16: 'Digital Assets',
        introduce17: 'Driving the adoption and application of digital assets and accelerating the development of the Web3 ecosystem.',
        introduce18: 'About Bityond',
        introduce19: 'Bityond is a leading digital asset trading platform dedicated to deeply integrating traditional financial markets with the Web3 ecosystem through innovative blockchain and cryptocurrency solutions. The company provides a full range of digital financial services, including asset management, trading, staking, and payments, offering global users premium investment opportunities and financing solutions.',
        introduce20: 'Ready to start trading digital currencies?',
        introduce21: 'Providing comprehensive digital asset trading services for global users',
        introduce22: 'Join Us',
        introduce23: '',
    }
