        ...
        <div class="rightarea-con">
          <div class="form-group">
            ...
            <Button type="warning" @click="queryOrder"
              style="padding: 6px 30px;margin-left:10px;background-color:#000;border-color:#f0a70a">{{
  ...
  data() {
    return {
      ...
      recordType: [
        ...
        {
          value: 35,
          label: this.$t("uc.finance.record.transMessage35")
        },
        {
          value: 36,
          label: this.$t("uc.finance.record.transMessage36")
        },
        {
          value: 37,
        ...
        {
          value: 40,
          label: this.$t("uc.finance.record.transMessage40")
        }
      ],
      coinList: [],
      coinType: "",
