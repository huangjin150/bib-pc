      ...
      <div class="bill_box_address">
        ...
        <section>
          <div class="table-inner">
            ...
            <div class="btnbox">
              <Button id="addrSubmit" @click='addAddr' size="large"
                style="width:86px;color:#fff;background:#f0a70a;border:1px solid #f0a70a;">{{
    ...
    <Modal v-model="modal2" width="360">
      ...
      <div style="text-align:center">
        <Form ref="formValidateAddr" :model="formValidateAddr" :rules="ruleValidate" :label-width="85">
          ...
          <!-- 手机验证码 -->
          <FormItem :label="$t('uc.finance.withdraw.smscode')" v-show="validPhone" prop="vailCode2">
      ...
      <div slot="footer">
        <Button type="primary" size="large" long @click="handleSubmit('formValidateAddr')">{{
...
export default {
  ...
  methods: {
    ...
    addAddr() {
      console.log('this.withdrawAddr', this.withdrawAddr)
