    ...
    data() {
        return {
            ...
            faqList: [
                {
                    q: '今天的加密货币价格、图表和数据',
                    a: '欢迎来到 BIBCEX！本网站由 Doctor.Han 于2013年创立，旨在提供最新的加密货币价格、图表和有关新兴加密货币市场的数据。BIBCEX 是全球首家承诺100%储备金的主流交易所，与美国知名审计公司 Armanino LLP 密切合作，定期公开 Merkle Tree 开源方案，让用户可以验证他们的资产100%存放在 BIBCEX 中。'
                },
                {
                    q: '我们免费提供实时和历史加密货币图表',
                    a: 'BIBCEX 的加密货币价格和行情图表展示了全球多种加密货币的实时市场，不仅有准确的实时价格走势，还有专业的趋势分析。BIBCEX 帮助您即时掌握加密货币市场的最新动态。  BIBCEX 实时更新热门加密货币的价格，显示过去 1 小时、24 小时和 7 天的币种价格变化，以及过去 24 小时的交易量和加密货币的当前市值。BIBCEX 还提供清晰简洁的近 7 天价格趋势图，帮助您更好地了解加密货币市场的波动情况。'
                },
                {
                    q: '我们如何计算我们的加密货币价格？',
                    a: '基于特定加密货币在不同交易所的币对，BIBCEX 使用全球交易量和平均价格公式计算加密货币价格。  每个加密货币交易所呈现的加密货币价格都不尽相同，但差别并不大。原因简单分为：投资吸引力、供求关系、挖矿难度或哈希率、监管政策的变化以及热门加密货币的波动性。此外，每种加密货币在不同的交易所市场进行交易和流通，其经济影响和流动性不同，计算出来的价格也会不同。'
                },
                {
                    q: '最值得投资的加密货币是什么？',
                    a: 'BIBCEX 加密货币价格和行情图表页为您提供了多种不同的加密货币，包括当前热门币种比特币、以太币和泰达币，及其他具有不同市场价值的代币。您可以关注收藏此页面，以便长期追踪加密货币价格走势，选择更好的投资方向。'
                },
                {
                    q: '什么原因导致某些加密货币变得热门？',
                ...
                {
                    q: '哪个是最值得投资的加密货币？',
                    a: 'BIBCEX 不提供关于哪个加密货币、代币或资产是否是良好投资的金融或投资建议，也不提供关于购买或出售时机的建议。我们是一家严谨的交易平台。 请记住，金融资产的价格、收益和价值会发生变化。这意味着您可能投资的任何资本都有风险。我们建议您寻求专业投资顾问的建议，以获得与您的个人情况相关的指导。'
                },
                {
                    q: '我今天应该投资加密货币吗？',
