        ...
        <div class="security-section">
            ...
            <div class="features-container">
                ...
                <div class="feature-item">
                    ...
                    <p class="feature-description" style="color: #aaa;">BIBCEX 是首家承诺 100% 储备金的主流平台</p>
                    <a href="#" class="feature-link">
                        <img src="../../assets/svg/arrow_rg.svg" alt="详情" style="filter: invert(1);">
                    </a>
                </div>
    ...
    data() {
        return {
            ...
            faqList: [
                {
                    q: '什么是全球综合资产交易平台？',
                    a: '全球综合资产交易平台是为用户提供多品类金融资产买卖和交易的平台，支持包括虚拟币（BTC、ETH 等超过 3,400 种）、全球顶级美股以及大宗商品（黄金、原油等）。BIBCEX 是全球领先的综合交易平台，致力于为用户提供一站式、全方位的数字资产与传统金融交易体验。'
                },
                {
                    q: 'BIBCEX 提供哪些产品？',
                    a: '作为全球领先的综合交易平台，BIBCEX 提供丰富的产品和服务，包括虚拟币现货与合约交易、美股交易、大宗商品交易，以及 Launchpool、余币宝、链上赚币等理财产品，满足不同用户的多元化投资需求。请注意，BIBCEX 可能会限制或禁止来自受限制地区的所有或部分服务。'
                },
                {
                    q: '如何在 BIBCEX 购买虚拟币、美股和大宗商品？',
                    a: '在 BIBCEX 购买各类资产仅需注册账户，完成身份验证，充值法币或数字货币，前往交易页面选择所需资产（虚拟币、美股或大宗商品）并下单即可。平台支持多种支付方式，一个账户即可连通三大投资市场。'
                },
                {
                    q: '如何追踪各类资产的市场价格？',
                    a: '您可以通过 BIBCEX 官网或 APP 实时查看虚拟币、美股和大宗商品的市场行情，亦可设置价格提醒、自选资产列表，随时掌握全球核心资产的价格动态。'
                },
                {
                    q: '如何在 BIBCEX 进行交易？',
                    a: '用户登录 BIBCEX 后，可前往交易和合约页面，在“虚拟币”、“美股”、“大宗商品”分类中挑选想要交易的标的进行买入或卖出。同时，也可使用跟单功能，跟随高阶用户策略自动交易。'
                },
                {
                    q: '为什么选择 BIBCEX 作为您的综合交易平台？',
                    a: 'BIBCEX 成立于 2013 年，是全球领先的交易平台之一。平台储备金规模超过 100 亿美元，打破传统金融与加密世界的壁垒，支持虚拟币、美股、大宗商品三大核心模块。注册用户可享受新人福利，是全球超过 4300万 用户的首选平台。'
                }
            ]
        }
    },
